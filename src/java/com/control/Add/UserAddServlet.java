...
public class UserAddServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (flag == 1) {
                out.println("<script language='javascript'>window.location.href='manage.jsp';alert('添加员工成功！')</script>");
            } else {
                out.println("<script language='javascript'>window.location.href='manage.jsp';alert('添加员工失败！')</script>");
            }
        }
    }
