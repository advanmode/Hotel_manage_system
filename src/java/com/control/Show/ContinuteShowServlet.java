 ...
 * @author 钟镇斌
 */
@WebServlet(name = "ContinuteShowServlet", urlPatterns = {"/ContinuteShowServlet"})
public class ContinuteShowServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("continute_list", list);
            RequestDispatcher dispatcher = request.getRequestDispatcher("show/continute_show.jsp");
